...
class Generic_MIL_Dataset(Generic_WSI_Classification_Dataset):
    ...
    def __getitem__(self, idx):        
        ...
        if not self.use_h5:
            if self.data_dir:
                full_path = os.path.join(self.data_dir,'{}.pt'.format(slide_id)) #self.data_dir
                #print('useh5')
            ...
            full_path = os.path.join(self.data_dir,'{}'.format(slide_id.replace("BLOCKS_NORM_MACENKO","FEATURES")))
            #print(full_path)
            #print(slide_id.replace("BLOCKS_NORM_MACENKO","FEATURES"))
            #full_path = "/mnt/isilon/"
            #print(full_path)
